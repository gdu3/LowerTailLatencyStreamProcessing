...
gcloud compute --project "storm-1102" ssh --zone "us-central1-b" "storm1" > /dev/null 2>&1 << eeooff
	...
	wget http://storm5/home/result/Acking_5.txt
	wget http://storm5/home/result/Failing_5.txt
	wget http://storm5/home/result/TimeoutV_5.txt
	wget http://storm5/home/result/IshuffleInfo_5.txt
	wget http://storm5/home/result/RecvQDelay_5.txt
